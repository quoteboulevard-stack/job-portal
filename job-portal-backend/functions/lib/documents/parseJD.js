...
async function parseWithClaude(text) {
    const message = await claude.messages.create({
        ...
        messages: [
            {
                role: 'user',
                content: 'Extract the following fields from this job description and return ONLY valid JSON, no markdown:\n' +
...
exports.parseJD = functions
    ...
    const doc = { jobId, parsed, meta, status: 'success', updatedAt: serverTs };
